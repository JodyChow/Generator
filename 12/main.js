...
const noseBox = document.querySelector("#noses");
...
// SLIDER FIVE : NOSE //
// SLIDER FIVE : NOSE //
const noseOne = document.querySelector("#noseone");
const noseTwo = document.querySelector("#nosetwo");

const slider5 = document.querySelector(".slider5");

slider5.oninput = () => {
    let value = slider5.value;

    if (value <= 1) {
        noseOne.style.marginTop = "15px";
    }

    if (value >= 1) {
        noseOne.style.marginTop = "-100px";
        noseTwo.style.marginTop = "15px";
    }
}
